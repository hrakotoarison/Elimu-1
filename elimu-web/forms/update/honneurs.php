...
<table border="0" cellpadding="3" cellspacing="0" width="100%" align=center >
		...
		<TR>
<TD ALIGN=LEFT ROWSPAN=1 NOWRAP><B>&nbsp;Libelle Honneurs *</B>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE="text" SIZE=30 MAXLENGTH="100" NAME="discipline" ONCHANGE="this.value=this.value.toUpperCase()" value="<?php echo $libelle?>" id="libelle" readonly ></td></tr>
<TR><TD class=petit>&nbsp;</TD></TR>
