	...
	<table border="0" cellpadding="3" cellspacing="0" width="600" >
		...
		<tr>
			<td width="234" >Nom du Classeur</td><td>
				<input name="Nom" id="Nom" value="<?echo $info[2];?>"size=40 class="inputbig" type="text" lang="bonfond:#FFFFFF;bontexte:#400040; erreurfond:#FF0000;bontexte:#0000FF; type:obligatoire;erreur:champs Obligatoire">
			</td>
			</tr>
			...
			<td width="234" >Specification</td><td>
				<input name="Specification" id="Spécification" value="<?echo $info[4];?>" size=40 class="inputbig" type="text" lang="bonfond:#FFFFFF;bontexte:#400040; erreurfond:#FF0000;bontexte:#0000FF; type:obligatoire;erreur:champs Obligatoire">
			</td>
		</tr>

			<tr>
			<td width="234" >Nombre de dossiers</td><td>
				<input name="nbre_dos" id="nbre de dossiers" value="<?echo $info[3];?>" size="5" class="inputbig" type="text" lang="bonfond:#FFFFFF;bontexte:#400040; erreurfond:#FF0000;bontexte:#0000FF; type:nombre;erreur:champs Obligatoire">
			</td>
		</tr>
